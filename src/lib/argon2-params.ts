...
/**
 * Argon2id mit den OWASP-Referenzparametern (19 MiB Speicher, 2 Iterationen, Parallelität 1).
 *
 ...
 * `const enum`, den TypeScript unter `isolatedModules` nicht zur Laufzeit auflösen kann.
 */
